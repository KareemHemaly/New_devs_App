...
async def calculate_monthly_revenue(property_id: str, tenant_id: str, month: int, year: int, db_session=None) -> Decimal:
    ...
    async with (await db_pool.get_session()) as session:
        ...
        result = await session.execute(query, {"property_id": property_id, "tenant_id": tenant_id, "start_date": start_date, "end_date": end_date})
...
async def calculate_total_revenue(property_id: str, tenant_id: str) -> Dict[str, Any]:
    ...
    try:
        ...
        mock_data = {
            ...
            ('prop-001', 'tenant-b'): {'total': '2100.00', 'count': 2},
